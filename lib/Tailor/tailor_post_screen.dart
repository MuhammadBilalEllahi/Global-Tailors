  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        width: MediaQuery.of(context).size.width - 40,
        child: Image.network( 
                                'https://buffer.com/cdn-cgi/image/w=1000,fit=contain,q=90,f=auto/library/content/images/size/w1200/2023/10/free-images.jpg', fit: BoxFit.fill,),
      ),
    );
  }
}
